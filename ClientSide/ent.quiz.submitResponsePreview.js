        ...
        ENTQuiz.Response = {
            ...
            initializePage: function () {
                ...
                if (ENTQuiz.Common.getUrlParams("quizId") != undefined) {
                    ...
                    let apiPath_item = this.apiPath + '/getActiveQuizPreview?quizId=' + quizId + '&absolutePath=' + location.pathname;
            ...
            renderQuiz: function () {
                if (this.quiz != undefined &&
                    ...
                    if (this.quiz.status == 0) $("#btnPublishQuiz").show();
                    ...
                    if (this.userLanguage == 1) {
                        ...
                        $("[name='btnPublishQuiz']").text("PublishInArabic");
                    }
                    else {
                    ...
                    if (!this.quiz.AllowCancel)
                        $("[name='btnModCancel']").hide();
